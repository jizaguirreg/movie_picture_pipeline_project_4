...
# Github Action role
####################
resource "aws_iam_user" "github_action_user2" {
  name = "github-action-user2"
}

resource "aws_iam_user_policy" "github_action_user2_permission" {
  user   = aws_iam_user.github_action_user2.name
